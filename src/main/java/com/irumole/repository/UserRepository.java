package com.irumole.repository;
...
public class UserRepository extends Database {
    ...
    private MongoCollection<User> getUserMongoCollection(){
        return database.getCollection("user", com.irumole.model.User.class);
    }

    public Optional<com.irumole.model.User> getUser(String username){
